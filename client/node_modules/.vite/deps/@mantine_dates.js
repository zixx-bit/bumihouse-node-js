...
var DateInput = (0, import_react19.forwardRef)((props, ref) => {
  ...
  const _getDayProps = (day) => __spreadProps10(__spreadValues22({}, getDayProps == null ? void 0 : getDayProps(day)), {
    ...
    onClick: () => {
      ...
      const val = clearable && _allowDeselect ? (0, import_dayjs22.default)(_value).isSame(day, "day") ? null : valueWithTime : valueWithTime;
      setValue(val);
...
var PickerInputBase = (0, import_react23.forwardRef)((props, ref) => {
  ...
  return import_react23.default.createElement(import_react23.default.Fragment, null, dropdownType === "modal" && !readOnly && import_react23.default.createElement(Modal, __spreadValues24({
    ...
    returnFocus: true,
    unstyled
  }, popoverProps), import_react23.default.createElement(Popover.Target, {
    shouldOverrideDefaultTargetId: !hasLabel
  }, import_react23.default.createElement(Input, __spreadValues24(__spreadProps11(__spreadValues24({
