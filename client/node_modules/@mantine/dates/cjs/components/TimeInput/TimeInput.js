...
const TimeInput = React.forwardRef((props, ref) => {
  const _a = core.useComponentDefaultProps("TimeInput", defaultProps, props), {
    required,
    label,
    error,
    description,
  ...
  const { classes, cx, theme } = TimeInput_styles['default']({ size }, { classNames, styles, unstyled, name: "TimeInput" });
