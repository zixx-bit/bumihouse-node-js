...
const PickerInputBase = React.forwardRef((props, ref) => {
  ...
  const { classes, cx } = PickerInputBase_styles['default'](null, {
  ...
  const _rightSection = rightSection || (clearable && shouldClear && !readOnly && !disabled ? /* @__PURE__ */ React__default.createElement(core.CloseButton, __spreadValues({
    variant: "transparent",
    onClick: onClear,
    unstyled,
    size: inputProps.size
  ...
  }), others), formattedValue || /* @__PURE__ */ React__default.createElement(core.Input.Placeholder, {
